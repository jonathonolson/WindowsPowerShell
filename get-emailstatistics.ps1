function get-dategui {
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK)
    {
        ...
        $date #Write-Host "Date selected: $($date.ToShortDateString())"
    }
}
...
$today = get-dategui -message "Enter the End Date"
$rundate = get-dategui -message "Enter the Start Date" 
